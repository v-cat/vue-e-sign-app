<template>
  <div class="announcement" v-loading="loading" element-loading-text="拼命加载中" element-loading-background="rgba(236,235, 235, 0.8)">
    <!-- 合同表格 -->
              ...
              <el-table ref="table" :data="tableData" align="center" tooltip-effect="dark" style="width: 100%" height="380" @select-all="SelectAll" @select="SelectOne" @selection-change="handleSelectionChange">
                ...
                <el-table-column label="操作 " align="center " width="200 " show-overflow-tooltip>
                  <template slot-scope="scope">
                    <!-- <a class="search-infor-btn" @click="Detial('001,004')">详情</a> -->
                    <router-link to="accountManagement/personalinfor" class="search-infor-btn">详情</router-link>
