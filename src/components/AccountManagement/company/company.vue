<template>
  ...
  <div class="company">
    <OBJECT
      ID="SesSealOcx"
      style="display: none"
      CLASSID="clsid:86E42EBD-C877-4BA3-A26F-7DEA1B200A11"
      codeBase="./WAFA-SES.CAB#Version=1,0,0,2"
      width="0"
      height="0"
    ></OBJECT>
    <div class="company-contract-body margin100">
                    ...
                    <ul>
                      <li>
                        ...
                        >
                          <el-upload
                            ...
                            action=""
                            :http-request="()=>{}"
                            :on-change="AddXlicence"
                            :before-upload="CheckFile"
                            :on-remove="RemoveXlicence"
                          >
                            <div class="uplodebtn">
                            ...
                            >支持文件类型:JPG、JPEG、GIF、PNG、PDF 文件大小:5M以内</div>
                          </el-upload>
                        </el-form-item>
                      </li>
                      <li>
                      ...
                      <li>
                        ...
                        >
                          <el-input
                            type="text"
                            placeholder="统一社会信用代码/工商注册号"
                            v-model="ruleForm.vcorpid"
                          ></el-input>
                        </el-form-item>
                      </li>
                      <li>
                        ...
                        >
                          <el-input
                            type="text"
                            v-model="ruleForm.vlegalman"
                            placeholder="请填写企业法定代表人的真实姓名"
                          ></el-input>
                        </el-form-item>
                      </li>
                      <li>
                        ...
                        >
                          <el-upload
                            ...
                            :http-request="()=>{}"
                            :before-upload="CheckFile"
                            :on-change="AddXauthorization"
                            :on-remove="RemoveXauthorization"
                          >
                            <div class="uplodebtn">
                              <el-button type="primary">
                                <i class="el-icon-upload2">点击上传</i>
                      ...
                      <li>
                        ...
                        >
                          <el-input
                            type="text"
                            v-model="ruleForm.vbankname"
                            placeholder="企业对公账户开户行"
                          ></el-input>
                        </el-form-item>
                      </li>
                      <li>
                      ...
                      <li>
                        ...
                        >
                          <el-input
                            type="text"
                            v-model="ruleForm.vtaxpayeridnum"
                            placeholder="纳税人识别号"
                          ></el-input>
                        </el-form-item>
                      </li>
                      ...
                      >
                        <el-button
                          ...
                          :disabled="!ruleForm.agree"
                        >提交</el-button>

                        <el-dialog
                          title="是否确认提交？"
                          :visible.sync="SubmitInfo"
      ...
      >
        <div class="enterprise">
              ...
              <div class="block-item basic">
                ...
                >
                  ...
                  <a @click="Certification">
                    <button
                      type="button"
                      class="el-button bordered el-button--primary"
                    >
                  ...
                  <span
                    ...
                    @click="CompanyInfor=true"
                  >加入企业</span>
                  <el-dialog
                    title="加入企业"
                    :visible.sync="CompanyInfor"
                    :before-close="handleClose"
                  >
                    <el-form
                      :model="ruleForm"
                    ...
                    >
                      <el-button
                        class="cancel-button"
                        @click="CompanyInfor = false"
                      >取 消</el-button>
                      <el-button
                        class="join-button "
                        type="primary"
                        @click="JoinCompany('ruleForm')"
                      >申请加入</el-button>
                ...
                >
                  ...
                  <el-button
                    type="primary"
                    @click="CompanyEnter=true"
                  >申请接入</el-button>
                  <el-dialog
                    title="新增终端"
                    :visible.sync="CompanyEnter"
                    :before-close="handleClose"
                  >
                    <el-form
                      :model="ruleForm"
                    ...
                    >
                      ...
                      >
                        <el-input
                          v-model="ruleForm.terminalkey"
                          placeholder="6-12位字符"
                        ></el-input>
                      </el-form-item>
                      <el-form-item
                        prop="terminalkeysure"
                        label="确认激活码:"
                      >
                        <el-input
                          v-model="ruleForm.terminalkeysure"
                          placeholder="6-12位字符"
                        ></el-input>
                      </el-form-item>
                      <el-form-item
                      ...
                      >
                        <el-select
                          v-model="ruleForm.selCert"
                          placeholder="选择证书"
                          style="float:left"
                        >
                          <el-option
                            v-for="(item,idx) of ruleForm.certs"
                            :key="idx"
                            :label="item.name"
                            :value="item"
                          >
                      ...
                      >
                        <el-input
                          v-model="ruleForm.terminalnumber"
                          placeholder="请输入序号"
                        ></el-input>
                      </el-form-item>
                    </el-form>
                    ...
                    >
                      <el-button
                        class="cancel-button  search-infor-a"
                        @click="CompanyEnter =false"
                      >取消</el-button>
                      <el-button
                        class="join-button  search-infor-a"
                        @click="ApiAdd"
                      >保存</el-button>
                    </span>
                  </el-dialog>
          ...
          <div
            class="utility el-row"
            style="margin-left: -10px; margin-right: -10px;"
          >
            <div
              class="el-col el-col-12 el-col-lg-8"
              style="padding-left: 10px; padding-right: 10px;"
            >
              <div
                class="item"
                v-if="auth.ddefine1===0"
              >
                <p class="title">点击认证</p>
                <div class="tip">只提供给电信接入</div>
                <div>
                  <el-button
                    type="primary"
                    @click="clickAuth=true"
                  >点击认证</el-button>
                  <el-dialog
                    title="认证"
                    :visible.sync="clickAuth"
                  >
                    <el-form
                      :model="ruleForms"
                      :rules="ruless"
                    ...
                    >
                      <el-button
                        class="cancel-button  search-infor-a"
                        @click="clickAuth =false"
                      >取消</el-button>
                      <el-button
                        class="join-button button-save search-infor-a"
                        @click="SaveAuth"
                      >保存</el-button>
                    </span>
                  </el-dialog>
            ...
            >
              <div class="item">
                ...
                <div
                  class="bg"
                  style="background-position: -90px 0px;"
                ></div>
              </div>
            </div>
            <div
            ...
            >
              <div class="item">
                ...
                <div
                  class="bg"
                  style="background-position: -90px -90px;"
                ></div>
              </div>
            </div>
            <div
            ...
            >
              <div class="item">
                ...
                <div
                  class="bg"
                  style="background-position: -90px -180px;"
                ></div>
              </div>
            </div>
            <div
            ...
            >
              <div class="item">
                ...
                <div
                  class="bg"
                  style="background-position: 0px -270px;"
                ></div>
              </div>
            </div>
            <div
            ...
            >
              ...
              >
                ...
                <div
                  class="bg"
                  style="background-position: -90px -270px;"
                ></div>
              </div>
            </div>
          </div>
          ...
          >
            <div
              class="el-dialog el-dialog--tiny"
              style="top: 15%;"
            >
